...
import CustomNav from './comp/CustNav';
      ...
      <header className='max:md:fixed max-md:h-1/2 md:h-28 bg-white top-0 max-md:z-10  w-screen border-b-2 border-x-black shadow-sm '>
        <nav className='h-full md:grid max-md:flex grid-cols-2 gap-2'>
          <div className='relative h-full w-full'>
            <div className='absolute w-screen md:transform md:-translate-y-1/2 md:top-1/2 md:left-2 max-md:top-3 max-md:left-3'>
          ...
          <div className='md:relative max-md:w-screen max-md:h-screen'>
            <div className='md:hidden relative'>
              {/* <img className='h-8 w-8' src={String(menu)} /> */}
              <CustomNav className='h-8 w-8 overflow-hidden'
                li={[
                  ["ABOUT ME"],
                  ["RESUME"],
                  ["PROJECT"],
